...
export const NOT_FOUND = [404, ":item."];
export const DB_ERROR = [500, "Database error while :item."];
export const MAX_ATTEMPTS = [400, "Max attempts for OTP verification."];
export const OTP_EXPIRED = [400, "OTP expired"];
